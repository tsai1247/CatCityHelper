...
const characterList = [
  ...
  },
  {
    ...
    skills: {
      ...
      Passive: {
        name: "秘境仙鈴",
        description: "戰鬥開始時，按自身戰前爆擊率抵抗的50%，提升自身爆擊率",
        arguments: [
          ["50%"],
          ["58.3%"],
          ["66.7%"],
  ...
  },
  {
    ...
    skills: {
      Sp: {
        name: "激雷破",
        description: "按{{}}攻擊力，對敵方單體造成傷害，並提升自身{{}}防禦力2回合",
        arguments: [
          ["229%"],
          ["243%"],
          ["264%"],
  ...
  },
  {
    ...
    skills: {
      ...
      Passive: {
        name: "糾察有方",
        description: "僅PVP模式戰中，友方全體造成最終傷害提升9%",
        arguments: [
          ["9%"],
          ["10.5%"],
          ["12%"],
    ...
    skills: {
      ...
      Passive: {
        ...
        arguments: [
          ...
          ["除自己以外，每有1名上陣戰鬥員的粒子形態為「三相」", "16%", "（可疊加，最高3層）"],
        ]
      },
      risingStar: [
  ...
  },
  {
    ...
    skills: {
      ...
      Passive: {
        name: "灼心",
        description: "所有例子型態為「星流」的友方基礎能力提升{{}}（死亡後也生效）",
        arguments: [
          ["4%"],
          ["4.7%"],
          ["5.3%"],
